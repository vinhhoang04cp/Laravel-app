...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of errors of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} errors` The number of errors in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, errors ) {
