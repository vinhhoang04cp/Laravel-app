                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ownership_registration_number"
                                   ...
                                   id="ownership_registration_number" value="{{ old('ownership_registration_number') }}"
                                   required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="shares" class="form-control @error('shares') is-invalid @enderror"
                                   id="shares" value="{{ old('shares') }}" required>
                            @error('shares')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="registration_status" id="registration_status"
                                ...
                                <option value="Chưa đăng ký" selected>Chưa đăng ký</option>
                                <option value="Đã đăng ký">Đã đăng ký</option>
                                <option value="Ủy quyền">Ủy quyền</option>
                            </select>
